          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                {' '}
                (
                {(stats.invalid_shares_five_min / totalSharesFiveMin).toFixed(
                  1
                )}
                %)
              </td>
            ...
            <tr>
              ...
              <td>
                ...
                {' '}
                (
                {(stats.invalid_shares_one_hour / totalSharesOneHour).toFixed(
                  1
                )}
                %)
              </td>
            ...
            <tr>
              ...
              <td>
                ...
                {' '}
                (
                {(stats.invalid_shares_six_hour / totalSharesSixHours).toFixed(
                  1
                )}
                %)
              </td>
