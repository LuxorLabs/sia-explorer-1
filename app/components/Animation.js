...
import dotTextureImg from 'assets/imgs/dotTexture.png'
...
class Animation extends Component {
  componentDidMount () {
    setTimeout(() => {
      // querySelector on canvas elem
      var canvas = document.querySelector('canvas')
      // Get width and height of the canvas
      var width = canvas.offsetWidth
      var height = canvas.offsetHeight
      // Create 3 diff colors?
      var colors = [
        new THREE.Color(0x31ab67),
        new THREE.Color(0x22ed82),
      ...
      var camera = new THREE.PerspectiveCamera(80, width / height, 0.1, 400)
      ...
      loader.crossOrigin = ''
      var dotTexture = loader.load(dotTextureImg)
      var dotsAmount = 1000
    ...
    return (
      <AnimationWrap>
        <div className='content'>
          <canvas className='scene scene--full' id='scene' />
